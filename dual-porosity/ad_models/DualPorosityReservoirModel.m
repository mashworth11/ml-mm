...
properties
    ...
    %% DataDrivenTransferFunction
    dd_transfer_object % data driven transfer function
end
...
methods
    ...
    function model = DualPorosityReservoirModel(G, varargin)
        ...
        %% Dual porosity: adding 'dummy' data driven structure
        model.dd_transfer_object = struct();
